...
<div class="text-3xl text-zinc-400 mt-16 tracking-wide">
  Aiden · Flutter Seoul
</div>
...
<div class="text-4xl">3. Persona</div>
...
<div class="text-4xl">4. Skill</div>
...
<div class="text-4xl">5. Meta-Skill</div>
...
<div class="text-4xl">7. Agent</div>
<div class="text-2xl mt-20">주식 투자 에이전트의 목표</div>
...
<div class="text-4xl mb-20">7. Agent</div>
...
<!--
Boil the ocean, together
에이전트 군단을 지닌 사람들이 모여 바다를 끓일 때, 불가능해 보이는 일이 가능해질거라 믿습니다.
-->
...
<div class="text-zinc-500 mt-12 text-2xl">
